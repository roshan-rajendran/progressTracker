        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center items-center p-4">
            <div className="w-full max-w-sm text-center">
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mt-4">Welcome to Zenith</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-1">The future of project management.</p>
                </div>

                <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
                    <button
                        onClick={() => setIsModalOpen(true)}
                        className="w-full inline-flex items-center justify-center px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-600 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary dark:focus:ring-offset-gray-800"
                    >
